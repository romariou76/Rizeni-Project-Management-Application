  ...
  return (
    <div className='WorkSpace'>
      <div className='form-modal'>
        <h2>Vamos a crear un Proyecto<br></br></h2>
        <p>Impulse su productividad facilitandoles a todos <br></br> el acceso al flujo de trabajo en una unica ubicacion </p>
        <br></br>
        <p className='title-space-style'>Nombre del nuevo Proyecto</p>
        ...
        <br></br>
        <p className='type-space-style'>Tipo de Proyecto</p>
        ...
        <p className='title-single-style'>El tipo de proyecto ayudara en el desarrollo del proyecto</p>
        <br></br>
        <p className='title-description-style'>Descripcion del Proyecto</p>
